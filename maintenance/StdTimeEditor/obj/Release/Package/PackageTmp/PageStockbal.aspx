<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="PageStockbal.aspx.cs" Inherits="StdTimeEditor.PageStockbal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="auto-style11">
            <asp:Label ID="Label4" runat="server" Text="ItemName : " style="text-align: right"></asp:Label>
        </td>
    ...
    <tr>
        ...
        <td class="auto-style12">
            <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                <ContentTemplate>
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSourceType" DataTextField="StatusType" DataValueField="StatusType">
                    </asp:DropDownList>

                    <asp:Button ID="bntgroup" runat="server" BackColor="#3399FF" Font-Bold="True" ForeColor="White" OnClick="bntgroup_Click" Text="print group report" Width="148px" />
    ...
    <tr>
        <td class="auto-style7">
            <asp:Label ID="Label11" runat="server" Text="Qty Bal :"></asp:Label>
        </td>
        <td class="auto-style8">
            <asp:UpdatePanel ID="UpdatePanel12" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="txtbal" runat="server" Width="111px">0</asp:TextBox>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
        <td class="auto-style8">&nbsp;</td>
    ...
    <tr>
        ...
        <td class="auto-style26">
            <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="txtprice" runat="server" Width="111px">0</asp:TextBox>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    ...
    <tr>
        ...
        <td class="auto-style10" style="left: auto">
            <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                <ContentTemplate>
                    <asp:Button ID="bntdelete0" runat="server" BackColor="#3399FF" Font-Bold="True" ForeColor="White" Text="Print Stock All" Width="154px" PostBackUrl="~/FrmPrintBal.aspx" OnClick="bntdelete0_Click" />
                </ContentTemplate>
            </asp:UpdatePanel>
    ...
    <tr>
        <td class="auto-style6" colspan="6">
                ...
                <ContentTemplate>
                    <dx:ASPxGridView ID="gvStdTime" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" EnableTheming="True" KeyFieldName="Itemcode" Theme="BlackGlass" Width="100%">
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="No" FieldName="Row" VisibleIndex="1" Width="40px">
                                <HeaderStyle HorizontalAlign="Center" />
                                <CellStyle HorizontalAlign="Center">
                                </CellStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Itemcode" FieldName="Itemcode" VisibleIndex="2">
                            ...
                            <dx:GridViewDataTextColumn Caption="Model" FieldName="Model" VisibleIndex="5">
                                <HeaderStyle Font-Bold="True" />
                                <CellStyle HorizontalAlign="Left">
                                </CellStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Location" FieldName="Location" VisibleIndex="6">
                                <HeaderStyle Font-Bold="True" />
                                <CellStyle HorizontalAlign="Left">
                                </CellStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Max" FieldName="MaxItem" VisibleIndex="8" Visible="False">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Min" FieldName="MinItem" VisibleIndex="9" Width="50px">
                                <HeaderStyle Font-Bold="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Qty In" FieldName="QtyIn" VisibleIndex="10" Width="60px">
                                <HeaderStyle Font-Bold="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Qty Out" FieldName="QtyOut" VisibleIndex="11" Width="60px">
                                <HeaderStyle Font-Bold="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Qty Bal" FieldName="QtyBal" VisibleIndex="12" Width="60px">
                                <HeaderStyle Font-Bold="True" />
                                <CellStyle BackColor="#99FFCC" Font-Bold="True">
                                </CellStyle>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Create Date" FieldName="Createdate" VisibleIndex="13">
                                <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                                <CellStyle HorizontalAlign="Center">
                                </CellStyle>
                            </dx:GridViewDataTextColumn>
                               <dx:GridViewDataHyperLinkColumn Caption="Edit" FieldName="Itemcode" VisibleIndex="14" Width="20px">
                        ...
                        <CellStyle HorizontalAlign="Center">
                            ...
                            <dx:GridViewDataTextColumn Caption="Price" FieldName="Price" VisibleIndex="7" Width="70px">
                                <HeaderStyle Font-Bold="True" HorizontalAlign="Right" />
                                <CellStyle HorizontalAlign="Right">
                                </CellStyle>
                            </dx:GridViewDataTextColumn>
                  
                              <dx:GridViewDataComboBoxColumn Caption="Type" FieldName="Statustype" VisibleIndex="4" ShowInCustomizationForm="True">
                                     <PropertiesComboBox DataSourceID="SqlDataSourceType" ValueType="System.String" ValueField="Statustype" TextField="Statustype" />
                                      <HeaderStyle Font-Bold="True" HorizontalAlign="Center" />
                        <CellStyle HorizontalAlign="Left">
                        </CellStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSourceType" runat="server" ConnectionString="<%$ ConnectionStrings:DBBarcode %>" SelectCommand="SELECT [StatusType] FROM [tb_StatusType]"></asp:SqlDataSource>
               </td>
    </tr>
</table>
    </div>
