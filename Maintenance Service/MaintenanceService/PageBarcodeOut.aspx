<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="PageBarcodeOut.aspx.cs" Inherits="MaintenanceService.PageBarcodeOut" %>
        ...
        <tr>
            <td class="auto-style9">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="Label3" runat="server" Text="Barcode Out:" Font-Size="Large"></asp:Label>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td colspan="4" class="auto-style10">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:TextBox ID="txtbal" runat="server" BackColor="#FFCCCC" Enabled="False" Height="23px" Width="66px"></asp:TextBox>
        ...
        <tr>
            <td class="auto-style6">
                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="Label5" runat="server" Font-Size="Large" Text="Employee code*:"></asp:Label>
                    </ContentTemplate>
            ...
            <td class="auto-style7">
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtemployee" runat="server" BackColor="#FFFFCC" Height="23px" Width="222px"></asp:TextBox>
                        <asp:Label ID="lblckemployee" runat="server" ForeColor="Red" Text="***" Visible="False"></asp:Label>
                        <asp:TextBox ID="txtempname" runat="server" Enabled="False" Height="23px" Width="343px" Visible="False"></asp:TextBox>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            ...
            <td class="auto-style7">
                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Button ID="bntdelete" runat="server" BackColor="#FFCCCC" Text="DELETE" Width="115px" OnClientClick="return ConfirmDelete();" OnClick="bntdelete_Click" />
        ...
        <tr>
            ...
            <td colspan="3">
              <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                <ContentTemplate>
                    <dx:ASPxGridView ID="gvStdTime" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSourceOut" EnableTheming="True" KeyFieldName="MovID" Theme="Default" Width="100%" >
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="QtyOut" VisibleIndex="5">
                            ...
                            <dx:GridViewDataTextColumn Caption="Create Date" FieldName="CreateDate" VisibleIndex="7">
                                <HeaderStyle Font-Bold="True" />
                            </dx:GridViewDataTextColumn>
                              <dx:GridViewDataHyperLinkColumn Caption="Delete" FieldName="MovID" VisibleIndex="11" Width="20px">
                        <PropertiesHyperLinkEdit ImageHeight="15px" ImageUrl="~/Images/pin.png" ImageWidth="15px" NavigateUrlFormatString="~/PageBarcodeOut.aspx?MovID={0}&amp;mode=Delete">
                        </PropertiesHyperLinkEdit>
                                  <HeaderStyle Font-Bold="True" />
                        <CellStyle HorizontalAlign="Center">
                        </CellStyle>
                    </dx:GridViewDataHyperLinkColumn>
                            <dx:GridViewDataTextColumn Caption="Employee" FieldName="Employee" VisibleIndex="6">
                                <HeaderStyle Font-Bold="True" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSourceOut" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataOut" TypeName="StdTimeEditor.DataAccess.ProjectDataSetTableAdapters.DataTable2TableAdapter"></asp:ObjectDataSource>
