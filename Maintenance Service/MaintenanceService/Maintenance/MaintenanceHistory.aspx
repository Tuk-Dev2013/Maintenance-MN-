<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Maintenance.Master" AutoEventWireup="true" CodeBehind="MaintenanceHistory.aspx.cs" Inherits="MaintenanceService.Maintenance.MaintenanceHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td>
                <asp:Label ID="Label3" runat="server" Text="Maintenance History" style="font-weight: 700"></asp:Label>
        ...
        <td colspan="5">
                        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" EnableTheming="True" KeyFieldName="IssueNo" Theme="Office2010Blue" Width="100%" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared">
                            <Columns>
                             ...
                             DisplayFormatString="รายงาน<b>{0}<b/>" 
                             NavigateUrlFormatString="FrmMNReport.aspx?id={0}">
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="MaintenanceService.DataAccess.ProjectDataSetTableAdapters.tb_DocIssueMNHistory" InsertMethod="Insert" UpdateMethod="Update">
                            <DeleteParameters>
                            ...
                            <InsertParameters>
                                ...
                                <asp:Parameter Name="ManagerRemark" Type="String" />
                                ...
                                <asp:Parameter Name="MNStatus" Type="String" />
                            </InsertParameters>
                            <UpdateParameters>
                                <asp:Parameter Name="IssueName" Type="String" />
                                <asp:Parameter Name="IssueDate" Type="DateTime" />
