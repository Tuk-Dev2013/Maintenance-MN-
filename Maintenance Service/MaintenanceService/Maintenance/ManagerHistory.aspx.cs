...
{
    public partial class ManagerHistory : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if ((Session["Grouppolicy"].ToString() == "User") || (Session["Grouppolicy"].ToString() == "MN"))
                {
                    Response.Redirect("~/Maintenance/FraMain.aspx");
                }

                this.lblstatus.Text = Session["Dept"].ToString();
              //  this.lblgroup.Text = Session["Grouppolicy"].ToString();
