<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site.Master" AutoEventWireup="true" CodeBehind="PageBarcodeIN.aspx.cs" Inherits="MaintenanceService.PageBarcodeIN" %>
...
.dx-clear
{
    ...
    <script type="text/javascript">
        ...
        function basicPopup() {
            popupWindow = window.open("ViewDetails.aspx", 'popUpWindow', 'height=600,width=680,left=100,top=30,resizable=No,scrollbars=No,toolbar=no,menubar=no,location=no,directories=no, status=No');
           // window.open('ViewDetails.aspx', 'pagename', 'resizable=no,width=200,height=400');
        }
    </script> 
</asp:Content>
...
<asp:Button ID="btnOpenPopupWindow" runat="server" Text="Open Production Order" OnClientClick="basicPopup();return false;" Width="212px" OnClick="btnOpenPopupWindow_Click" Visible="False" /> 
                <span class="auto-style7"><strong style="font-family: Arial, Helvetica, sans-serif; font-size: medium; font-style: normal; font-variant: normal; font-weight: bold;">Barcode scanning inventory system</strong></span></td>
            <td>&nbsp;</td>
        ...
        <tr>
            <td class="auto-style4">
                        <asp:Label ID="Label5" runat="server" Text="Select Order:" Font-Size="Large" ForeColor="#3333FF"></asp:Label>
                    </td>
            <td colspan="4">
                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="cboselect" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cboselect_SelectedIndexChanged" Width="50%">
                        </asp:DropDownList>
                    </ContentTemplate>
                </asp:UpdatePanel>
               </td>
        ...
        <tr>
            ...
            <td colspan="4">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtbarcode" runat="server" onkeypress="return EnterEvent(event)" BackColor="#FFFFCC" Height="23px" Width="262px" OnTextChanged="txtbarcode_TextChanged"></asp:TextBox>
