        ...
        <tr>
            <td class="auto-style6">
                <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                    <ContentTemplate>
                        <asp:Label ID="Label5" runat="server" Font-Size="Large" Text="Employee:"></asp:Label>
                    </ContentTemplate>
            ...
            <td class="auto-style7">
                <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                    <ContentTemplate>
                        <asp:TextBox ID="txtemployee" runat="server" BackColor="White" Height="23px" Width="353px"></asp:TextBox>
